...
# Duration
itt_max = 6000 # number of Monte Carlo steps
fps = 600# output period [number of MC steps]
# Ambient
temperature = 300 # [K]
frequency = 0.01 # [fs^-1]
# Deposition
drop = 750# number of droplets that will be deposited on the surface 
...
gx = 50 # number of sites along the X dir.
gy = 50 # number of sites along the y dir.
